...
# Logo dari GitHub anda (Primary) dan Bing (Fallback)
LOGO_URL = "https://raw.githubusercontent.com/Ziq-03/PUO-Geomatics/main/politeknik-ungku-umar-seeklogo-removebg-preview.png"
...
def auth_interface():
    ...
    with col2:
        # Menambah Logo dan Tajuk Login
        try:
            st.image(LOGO_URL, width=300)
        except:
            st.image(LOGO_FALLBACK, width=80)
