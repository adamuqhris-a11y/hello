...
show_poly = st.sidebar.checkbox("Paparkan Poligon Lot", value=True) # --- TAMBAHAN DI SINI ---
...
if uploaded_file:
    ...
    if tf:
        ...
        # 2. Lapisan Poligon Lot (Dengan Fungsi On/Off)
        if show_poly: # --- TAMBAHAN SYARAT DI SINI ---
            folium.Polygon(
